                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
									<textarea class="form-control" name="banner_description" placeholder="Description"  ></textarea> 
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
									<textarea class="form-control" name="banner_description_de" placeholder="Description"  ></textarea> 
									</div>
								</div>
