				...
				<div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i><?php echo $this->lang->line('add_cms');?></h3>
                            </div>
                            ...
                            <div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
									<textarea class="form-control" name="title_de" placeholder="title"  ></textarea> 
									</div>
								</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-xs-10">
									<textarea class="form-control" name="cms_description" placeholder="Description"  ></textarea> 
									</div>
								</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-xs-10">
									<textarea class="form-control" name="cms_description_de" placeholder="Description"  ></textarea> 
									</div>
								</div>
